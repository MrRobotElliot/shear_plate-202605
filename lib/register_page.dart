...
/// 注册：手机号 + 密码或短信验证码（二选一），或邮箱注册（邮箱 + 密码）。
...
class _PhoneRegisterTab extends StatefulWidget {
  const _PhoneRegisterTab();

  @override
  State<_PhoneRegisterTab> createState() => _PhoneRegisterTabState();
}

class _PhoneRegisterTabState extends State<_PhoneRegisterTab> {
                    ...
                    FilledButton(
                      onPressed: () {
                        if (_formKey.currentState?.validate() ?? false) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('注册接口待接入')),
                          );
                        }
                      },
                      child: const Text('注册'),
...
class _EmailRegisterTab extends StatefulWidget {
  const _EmailRegisterTab();

  @override
  State<_EmailRegisterTab> createState() => _EmailRegisterTabState();
}

class _EmailRegisterTabState extends State<_EmailRegisterTab> {
  final _formKey = GlobalKey<FormState>();
